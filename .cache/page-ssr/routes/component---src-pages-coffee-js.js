...
function Coffee(){let items=[];let[coffeeTitles,setCoffeeTitles]=react__WEBPACK_IMPORTED_MODULE_0__.useState([]);const mystyle={display:"flex",flexDirection:"row",justifyContent:"start"};react__WEBPACK_IMPORTED_MODULE_0__.useEffect(async()=>{console.log("Hello");let res=await fetch('https://api.sampleapis.com/coffee/hot');let coffees=await res.json();for(let i=0;i<coffees.length;i++){console.log(coffees[i]);console.log(coffees[i].title);items.push(/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div",{style:mystyle},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("img",{style:{width:"10%"},src:coffees[i].image}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div",{style:{marginLeft:"1rem"}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1",null,coffees[i].title),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p",null,coffees[i].description))));}setCoffeeTitles(items);},[]);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1",null,"Coffee"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("ul",null,coffeeTitles));}
...
;
//# sourceMappingURL=component---src-pages-coffee-js.js.map