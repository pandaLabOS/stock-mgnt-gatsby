...
// EXTERNAL MODULE: ./node_modules/react-bootstrap/esm/Card.js + 6 modules
var Card = __webpack_require__(444);
;// CONCATENATED MODULE: ./src/components/WineCard.js
function WineCard(props){const{image,title,description,winery,location,price,averageRating,reviews,handleClick}=props;const addToCart={backgroundColor:"#720017",color:"white",border:"1px #720017 solid",fontSize:"1em",display:"flex",alignItems:"center"};return/*#__PURE__*/react.createElement(Card/* default */.Z,{style:{width:'25rem',margin:'5px',display:"flex",flexDirection:"row",border:"1px #720017 solid"}},/*#__PURE__*/react.createElement(Card/* default.Img */.Z.Img,{variant:"top",src:image,style:{marginTop:"0.5rem",borderRadius:"10px",maxWidth:"150px"}}),/*#__PURE__*/react.createElement(Card/* default.Body */.Z.Body,null,/*#__PURE__*/react.createElement(Card/* default.Title */.Z.Title,null,title),/*#__PURE__*/react.createElement(Card/* default.Text */.Z.Text,null,price," THB"),/*#__PURE__*/react.createElement(Card/* default.Text */.Z.Text,null,"Winery: ",winery),/*#__PURE__*/react.createElement(Card/* default.Text */.Z.Text,null,location),/*#__PURE__*/react.createElement(Card/* default.Text */.Z.Text,null,averageRating," (",reviews," reviews)"),/*#__PURE__*/react.createElement(Button/* default */.Z,{style:addToCart,onClick:handleClick},"Add to Cart")));}
// EXTERNAL MODULE: ./node_modules/react-use/esm/useLocalStorage.js + 1 modules
var useLocalStorage = __webpack_require__(30);
;// CONCATENATED MODULE: ./src/pages/pos/wine-pos.js
/* provided dependency */ var fetch = __webpack_require__(1515);
const dummyPrice=Number(950);let total=(/* unused pure expression or super */ null && ([]));function PosPage(){const[wine,setwine]=(0,useLocalStorage/* default */.Z)('wine','Cabernet Sauvignon');let[wineTitles,setwineTitles]=react.useState([]);let[subMenu,setSubMenu]=react.useState('reds');let[cart,setCart]=(0,useLocalStorage/* default */.Z)('cart',[]);let[localData,setLocalData]=react.useState('XXX');function addToCart(wine){cart.push(wine);setCart([...cart]);}react.useEffect(()=>{let items=[];fetch(`https://api.sampleapis.com/wines/${subMenu}`).then(res=>res.json()).then(wines=>{for(let i=0;i<wines.length;i++){wines[i].price=dummyPrice;items.push(/*#__PURE__*/react.createElement(WineCard,{key:i,image:wines[i].image,winery:wines[i].winery,title:wines[i].wine,location:wines[i].location,price:wines[i].price,averageRating:wines[i].rating.average,reviews:wines[i].rating.reviews,handleClick:()=>{addToCart(wines[i]);}}));}setwineTitles(items);});},[subMenu]);return/*#__PURE__*/react.createElement(Container/* default */.Z,null,/*#__PURE__*/react.createElement("h1",{style:{color:"#720017"}},"Wine"),/*#__PURE__*/react.createElement(ButtonGroup/* default */.Z,null,/*#__PURE__*/react.createElement(Button/* default */.Z,{style:{backgroundColor:"#720017",border:"#FFFFFF"},variant:"secondary",onClick:()=>setSubMenu('reds')},"Reds"),/*#__PURE__*/react.createElement(Button/* default */.Z,{style:{backgroundColor:"#720017",border:"#FFFFFF"},variant:"secondary",onClick:()=>setSubMenu('whites')},"Whites"),/*#__PURE__*/react.createElement(Button/* default */.Z,{style:{backgroundColor:"#720017",border:"#FFFFFF"},variant:"secondary",onClick:()=>setSubMenu('sparkling')},"Sparkling"),/*#__PURE__*/react.createElement(Button/* default */.Z,{style:{backgroundColor:"#720017",border:"#FFFFFF"},variant:"secondary",onClick:()=>setSubMenu('rose')},"Rose"),/*#__PURE__*/react.createElement(Button/* default */.Z,{style:{backgroundColor:"#720017",border:"#FFFFFF"},variant:"secondary",onClick:()=>setSubMenu('dessert')},"Dessert")),/*#__PURE__*/react.createElement(Row/* default */.Z,null,/*#__PURE__*/react.createElement(Col/* default */.Z,{sm:8},/*#__PURE__*/react.createElement(Row/* default */.Z,null,wineTitles)),/*#__PURE__*/react.createElement(Col/* default */.Z,{sm:4},/*#__PURE__*/react.createElement(Row/* default */.Z,null,/*#__PURE__*/react.createElement("h2",null,"Cart")),cart.map(item=>{return/*#__PURE__*/react.createElement(Row/* default */.Z,null,/*#__PURE__*/react.createElement(Col/* default */.Z,{sm:1}),/*#__PURE__*/react.createElement(Col/* default */.Z,null,item.wine," - ",dummyPrice));}),/*#__PURE__*/react.createElement(Row/* default */.Z,null,/*#__PURE__*/react.createElement(Col/* default */.Z,null,/*#__PURE__*/react.createElement("b",null,"Total: ",cart.reduce((a,b)=>a+b.price,0)))))));}
...
;
//# sourceMappingURL=component---src-pages-pos-wine-pos-js.js.map