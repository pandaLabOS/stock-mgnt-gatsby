...
;// CONCATENATED MODULE: ./src/components/CoffeeCard.js
function CoffeeCard(props){const{image,title,description,price,handleClick}=props;const addToCart={backgroundColor:"#FE6601",color:"white",border:"1px #FFFFFF solid",fontSize:"1em",display:"flex",alignItems:"center"};return/*#__PURE__*/react.createElement(Card/* default */.Z,{style:{width:'15rem',margin:'5px'}},/*#__PURE__*/react.createElement(Card/* default.Img */.Z.Img,{variant:"top",src:image,style:{marginTop:"0.5rem",borderRadius:"10px"}}),/*#__PURE__*/react.createElement(Card/* default.Body */.Z.Body,null,/*#__PURE__*/react.createElement(Card/* default.Title */.Z.Title,null,title," - ",price),/*#__PURE__*/react.createElement(Card/* default.Text */.Z.Text,null,description),/*#__PURE__*/react.createElement(Button/* default */.Z,{style:addToCart,onClick:handleClick},"Add to Cart")));}
// EXTERNAL MODULE: ./node_modules/react-use/esm/useLocalStorage.js + 1 modules
var useLocalStorage = __webpack_require__(30);
;// CONCATENATED MODULE: ./src/pages/pos/index.js
/* provided dependency */ var fetch = __webpack_require__(1515);
const dummyPrice=65;function PosPage(){// window.localStorage['coffee'] = 'Latte'
...
const[coffee,setCoffee]=(0,useLocalStorage/* default */.Z)('coffee','Latte');/* 
    ...
    */let[coffeeTitles,setCoffeeTitles]=react.useState([]);let[subMenu,setSubMenu]=react.useState('hot');let[cart,setCart]=(0,useLocalStorage/* default */.Z)('cart',[]);let[localData,setLocalData]=react.useState('XXX');let total=0;function addToCart(coffee){console.debug(coffee);cart.push(coffee);console.log(cart);setCart([...cart]);}react.useEffect(()=>{let items=[];fetch(`https://api.sampleapis.com/coffee/${subMenu}`)//await is easier to understand. The 'then' is not ideal
...
coffees[i].price=59;console.log(coffees[i]);items.push(/*#__PURE__*/react.createElement(CoffeeCard,{key:i,image:coffees[i].image,title:coffees[i].title// description = {coffees[i].description}
,price:dummyPrice,handleClick:()=>{addToCart(coffees[i]);}}));}setCoffeeTitles(items);});},[subMenu]);return/*#__PURE__*/react.createElement(Container/* default */.Z,null,/*#__PURE__*/react.createElement("h1",null,"Coffee"),/*#__PURE__*/react.createElement(ButtonGroup/* default */.Z,null,/*#__PURE__*/react.createElement(Button/* default */.Z,{variant:"secondary",onClick:()=>setSubMenu('hot')},"Hot"),/*#__PURE__*/react.createElement(Button/* default */.Z,{variant:"secondary",onClick:()=>setSubMenu('iced')},"Iced")),/*#__PURE__*/react.createElement(Row/* default */.Z,null,/*#__PURE__*/react.createElement(Col/* default */.Z,{sm:10},/*#__PURE__*/react.createElement(Row/* default */.Z,null,coffeeTitles)),/*#__PURE__*/react.createElement(Col/* default */.Z,{sm:2},/*#__PURE__*/react.createElement(Row/* default */.Z,null,/*#__PURE__*/react.createElement("h2",null,"Cart")),cart.map(item=>{return/*#__PURE__*/react.createElement(Row/* default */.Z,null,/*#__PURE__*/react.createElement(Col/* default */.Z,null,item.title," - 59 Baht"));}),/*#__PURE__*/react.createElement(Row/* default */.Z,null,/*#__PURE__*/react.createElement(Col/* default */.Z,null,/*#__PURE__*/react.createElement("b",null,"Total: ",cart.reduce(item=>dummyPrice,0)))),/*#__PURE__*/react.createElement(Row/* default */.Z,null))));}
